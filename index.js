...
//nocache
require('./kurr.js')
nocache("./kurr.js", (module) => console.log(`${module} masih dalam pemantauan Wibu!`));
	...
	try {
		...
		if (anu.action == 'add') {
			...
			try {
				...
				sendButImage(anu.jid, teks, `BTR X-BOT OFC`, img,but = [{buttonId:`donasi`, 
			...
			try {
				...
				sendButImage(anu.jid, teks, `BTR X-BOT OFC`, img,but = [{buttonId: `Hello World!`, buttonText: {displayText: `SAYONARA !!`}, type: 1}], options = {contextInfo: {mentionedJid: [num, htod]}})
