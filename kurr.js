...
const ownerNumber = ["6282313021398@s.whatsapp.net", "994407294804@s.whatsapp.net", "6285693972595@s.whatsapp.net"];
...
try {
        ...
        bambang.groupRemove(mek.key.remoteJid, [nums]).catch((e) => { reply(`*ERR:* ${e}`) })
        bambang.sendMessage(mek.key.remoteJid, tekuss, MessageType.text, {contextInfo:{mentionedJid:[nums + "@s.whatsapp.net"]}})
        }
		...
		const conts = mek.key.fromMe ? bambang.user.jid : bambang.contacts[mek.sender]
        const pushname = mek.key.fromMe ? bambang.user.name : !conts ? '-' : conts.notify || conts.vname || conts.name || '-'   
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		...
		// GAME 
             game.cekWaktuFam(bambang, family100)
        ...
        if (game.isfam(from, family100)) {
            ...
            if (anjuy.length < 1){
                bambang.sendMessage(from, `Semua jawaban sudah tertebak\nKirim *${prefix}family100* untuk bermain lagi`, text)
		...
		const reply = (teks) => {
			bambang.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} - ${week} ${weton} - ${calender}`,body:"DON'T CLICK HERE",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/p/6349482305092740/6282313021398`}}})
		}
...
return '```' + string + '```'
		...
		const sendMess = (hehe, teks) => {
			bambang.sendMessage(hehe, teks, text, { quoted: ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
		}
		//>>>>>>>>STICKER<<<<<<<\\
      ...
      if (budy.length > 2500) {
        ...
        if (budy.includes("wa.me/","https://wa.me//","https://wa.me/")) {
        	if (!mek.key.fromMe){
			    ...
			    bambang.groupRemove(from, [kic]).catch((e) => { sticNotAdmin(from) })
            }
        }
			// MUTE
        if (isMuted){
        ...
        if (budy.includes("https://","http://")) {
			...
			bambang.sendMessage(from, ano, sticker, { quoted: mek})
				}
...
const fkontak = { 
                  key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: `0@s.whatsapp.net` } : {}) }, message: { 'contactMessage': { 'displayName': `${pushname}`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;${pushname},;;;\nFN:${pushname},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': fs.readFileSync('./logonya.jpg')}}}
   ...
   const sotoy = [
		...
		//runtime berjalan
           runi = process.uptime() 
           bambang.setStatus(`Bot Active During ${kyun(runi)} `).catch((_)=>_);
...
${nomor++}.  ${prefix}gay
${nomor++}.  ${prefix}lesby
${nomor++}.  ${prefix}bajingan
${nomor++}.  ${prefix}jancok
${nomor++}.  ${prefix}anjing
${nomor++}.  ${prefix}ngentod
${nomor++}.  ${prefix}ngentot
${nomor++}.  ${prefix}monyet
${nomor++}.  ${prefix}mastah
${nomor++}.  ${prefix}newbie
${nomor++}.  ${prefix}bangsat
${nomor++}.  ${prefix}bangke
${nomor++}.  ${prefix}sange
${nomor++}.  ${prefix}sangean
${nomor++}.  ${prefix}dakjal
${nomor++}.  ${prefix}horny
${nomor++}.  ${prefix}wibu
${nomor++}.  ${prefix}puki
...
${nomor++}.  ${prefix}bc [ _teks/reply gif/image/video with caption_ ]
${nomor++}.  ${prefix}tobc [ _reply sticker/audio with caption_ ]
${nomor++}.  ${prefix}return [ _javascript_ ]
${nomor++}.  ${prefix}clearall
${nomor++}.  ${prefix}delchat
${nomor++}.  ${prefix}mute
${nomor++}.  ${prefix}unmute
${nomor++}.  ${prefix}public
${nomor++}.  ${prefix}self
${nomor++}.  ${prefix}spam [ _teks|jumlah_ ]
${nomor++}.  ${prefix}demoteall
${nomor++}.  ${prefix}promoteall
${nomor++}.  ${prefix}addcmd [ _teks reply stc_ ]
${nomor++}.  ${prefix}delcmd [ _reply stc_ ]
${nomor++}.  ${prefix}listcmd
${nomor++}.  ${prefix}spamsw [ _teks|jumlah_ ]
${nomor++}.  ${prefix}upswteks [ _teks_ ]
${nomor++}.  ${prefix}upswlokasi [ _teks_ ]
${nomor++}.  ${prefix}upswaudio [ _reply audio_ ]
${nomor++}.  ${prefix}upswvoice [ _reply audio_ ]
${nomor++}.  ${prefix}upswsticker [ _reply sticker_ ]
${nomor++}.  ${prefix}upswimage [ _reply image with caption_ ]
${nomor++}.  ${prefix}upswgif [ _reply gif with caption_ ]
${nomor++}.  ${prefix}upswvideo [ _reply video with caption_ ]
${nomor++}.  ${prefix}shutdown
${nomor++}.  ${prefix}offline [ _alasan_ ]
${nomor++}.  ${prefix}online
${nomor++}.  ${prefix}exif [ _nama|author_ ]
${nomor++}.  ${prefix}setprofile [ _reply image_ ]
${nomor++}.  ${prefix}setname [ _teks_ ]
${nomor++}.  ${prefix}setprefix [ _multi/nopref/prefix_ ]
${nomor++}.  ${prefix}setbio [ _teks_ ]
${nomor++}.  ${prefix}leave
${nomor++}.  ${prefix}restart
${nomor++}.  ${prefix}addrespon [ _tanya|jawab_ ]
${nomor++}.  ${prefix}delrespon [ _nama_ ]
${nomor++}.  ${prefix}listrespon
${nomor++}.  ${prefix}readall
${nomor++}.  ${prefix}unreadall
${nomor++}.  ${prefix}archive
${nomor++}.  ${prefix}unarchiveall
${nomor++}.  ${prefix}pin
${nomor++}.  ${prefix}unpin
${nomor++}.  ${prefix}setmenu [ _ori/simpel_ ]
${nomor++}.  ${prefix}setallmenu [ _ori/simpel_ ]
${nomor++}.  ${prefix}leavetime [ _detik/menit/jam_ ]
${nomor++}.  ${prefix}bukatime [ _detik/menit/jam_ ]
${nomor++}.  ${prefix}tutuptime [ _detik/menit/jam_ ]
${nomor++}.  ${prefix}nano [ _nama file_ ]
│
─❒GAME MENU
${nomor++}.  ${prefix}tebakgambar
${nomor++}.  ${prefix}caklontong
│
─❒ WIBU
${nomor++}.  ${prefix}loli
${nomor++}.  ${prefix}husbu
${nomor++}.  ${prefix}milf
${nomor++}.  ${prefix}cosplay
${nomor++}.  ${prefix}wallml
│
─❒ DOWNLOAD
${nomor++}.  ${prefix}infogempa
${nomor++}.  ${prefix}pinterest
${nomor++}.  ${prefix}herolist
${nomor++}.  ${prefix}herodetail [ _hero_ ]
${nomor++}.  ${prefix}google [ _search_ ]
${nomor++}.  ${prefix}gimage [ _search_ ]
${nomor++}.  ${prefix}wiki [ _search_ ]
${nomor++}.  ${prefix}mediafire [ _link_ ]
${nomor++}.  ${prefix}ytsearch [ _judul_ ]
${nomor++}.  ${prefix}ytmp4 [ _link yt_ ]
${nomor++}.  ${prefix}ytmp3 [ _link yt_ ]
${nomor++}.  ${prefix}play [ _judul lagu_ ]
${nomor++}.  ${prefix}video [ _judul video_ ]
${nomor++}.  ${prefix}tinyurl [ _link_ ]
${nomor++}.  ${prefix}fetch [ _link_ ]
${nomor++}.  ${prefix}igdl [ _link_ ]
${nomor++}.  ${prefix}tiktokdl [ _link_ ]
${nomor++}.  ${prefix}pinterest [ _search_ ]
${nomor++}.  ${prefix}lirik [ _judul_ ]
${nomor++}.  ${prefix}tourl [ _reply image/video_ ]
${nomor++}.  ${prefix}resepmasakan [ _judul_ ]
${nomor++}.  ${prefix}artimimpi [ _teks_ ]
${nomor++}.  ${prefix}bilangangka [ _angka_ ]
${nomor++}.  ${prefix}kalkulator [ _angka_ ]
${nomor++}.  ${prefix}fancytext [ _teks_ ]
${nomor++}.  ${prefix}githubstalk [ _username_ ]
${nomor++}.  ${prefix}translate [ _teks kodebhs_ ]
${nomor++}.  ${prefix}ss [ _link_ ]
${nomor++}.  ${prefix}playstore [ _search_ ]
${nomor++}.  ${prefix}tiktokaudio [ _link_ ]
${nomor++}.  ${prefix}brainly [ _search_ ]
${nomor++}.  ${prefix}igstory [ _search_ ]
${nomor++}.  ${prefix}igstalk [ _link_ ]
${nomor++}.  ${prefix}twitter [ _link_ ]
${nomor++}.  ${prefix}twmp3 [ _link_ ]
${nomor++}.  ${prefix}linkwa [ _search_ ]
${nomor++}.  ${prefix}fb [ _link_ ]
${nomor++}.  ${prefix}chara [ _search_ ]
${nomor++}.  ${prefix}otaku [ _search_ ]
${nomor++}.  ${prefix}komiku [ _search_ ]
│
─❒ MAKER
${nomor++}.  ${prefix}blackpink
${nomor++}.  ${prefix}neon
${nomor++}.  ${prefix}greenneon
${nomor++}.  ${prefix}advanceglow
${nomor++}.  ${prefix}futureneon
${nomor++}.  ${prefix}sandwriting
${nomor++}.  ${prefix}sandsummer
${nomor++}.  ${prefix}sandengraved
${nomor++}.  ${prefix}metaldark
${nomor++}.  ${prefix}neonlight
${nomor++}.  ${prefix}holographic
${nomor++}.  ${prefix}text1917
${nomor++}.  ${prefix}minion
${nomor++}.  ${prefix}deluxesilver
${nomor++}.  ${prefix}newyearcard
${nomor++}.  ${prefix}bloodfrosted
${nomor++}.  ${prefix}halloween
${nomor++}.  ${prefix}jokerlogo
${nomor++}.  ${prefix}fireworksparkle
${nomor++}.  ${prefix}natureleaves
${nomor++}.  ${prefix}bokeh
${nomor++}.  ${prefix}toxic
${nomor++}.  ${prefix}strawberry
${nomor++}.  ${prefix}box3d
${nomor++}.  ${prefix}roadwarning
${nomor++}.  ${prefix}breakwall
${nomor++}.  ${prefix}icecold
${nomor++}.  ${prefix}luxury
${nomor++}.  ${prefix}cloud
${nomor++}.  ${prefix}summersand
${nomor++}.  ${prefix}horrorblood
${nomor++}.  ${prefix}thunder
${nomor++}.  ${prefix}pornhub
${nomor++}.  ${prefix}glitch
${nomor++}.  ${prefix}avenger
${nomor++}.  ${prefix}space
${nomor++}.  ${prefix}ninjalogo
${nomor++}.  ${prefix}marvelstudio
${nomor++}.  ${prefix}lionlogo
${nomor++}.  ${prefix}wolflogo
${nomor++}.  ${prefix}steel3d
${nomor++}.  ${prefix}wallgravity
${nomor++}.  ${prefix}shadow
${nomor++}.  ${prefix}cup
${nomor++}.  ${prefix}cup1
${nomor++}.  ${prefix}romance
${nomor++}.  ${prefix}smoke
${nomor++}.  ${prefix}burnpaper
${nomor++}.  ${prefix}lovemessage
${nomor++}.  ${prefix}undergrass
${nomor++}.  ${prefix}love
${nomor++}.  ${prefix}coffe
${nomor++}.  ${prefix}woodheart
${nomor++}.  ${prefix}woodenboard
${nomor++}.  ${prefix}summer3d
${nomor++}.  ${prefix}wolfmetal
${nomor++}.  ${prefix}nature3d
${nomor++}.  ${prefix}underwater
${nomor++}.  ${prefix}golderrose
${nomor++}.  ${prefix}summernature
${nomor++}.  ${prefix}letterleaves
${nomor++}.  ${prefix}glowingneon
${nomor++}.  ${prefix}fallleaves
${nomor++}.  ${prefix}flamming
${nomor++}.  ${prefix}harrypotter
${nomor++}.  ${prefix}carvedwood
${nomor++}.  ${prefix}arcade8bit
${nomor++}.  ${prefix}battlefield4
${nomor++}.  ${prefix}pubg
${nomor++}.  ${prefix}wetglass
${nomor++}.  ${prefix}multicolor3d
${nomor++}.  ${prefix}watercolor
${nomor++}.  ${prefix}luxurygold
${nomor++}.  ${prefix}galaxywallpaper
${nomor++}.  ${prefix}lighttext
${nomor++}.  ${prefix}beautifulflower
${nomor++}.  ${prefix}puppycute
${nomor++}.  ${prefix}royaltext
${nomor++}.  ${prefix}heartshaped
${nomor++}.  ${prefix}birthdaycake
${nomor++}.  ${prefix}galaxystyle
${nomor++}.  ${prefix}hologram3d
${nomor++}.  ${prefix}greenneon
${nomor++}.  ${prefix}glossychrome
${nomor++}.  ${prefix}greenbush
${nomor++}.  ${prefix}metallogo
${nomor++}.  ${prefix}noeltext
${nomor++}.  ${prefix}glittergold
${nomor++}.  ${prefix}textcake
${nomor++}.  ${prefix}starsnight
${nomor++}.  ${prefix}wooden3d
${nomor++}.  ${prefix}textbyname
${nomor++}.  ${prefix}writegalacy
${nomor++}.  ${prefix}galaxybat
${nomor++}.  ${prefix}snow3d
${nomor++}.  ${prefix}birthdayday
${nomor++}.  ${prefix}goldplaybutton
${nomor++}.  ${prefix}silverplaybutton
${nomor++}.  ${prefix}freefire
${nomor++}.  ${prefix}foliokanan [ _text_ ]
${nomor++}.  ${prefix}foliokiri [ _text_ ]
${nomor++}.  ${prefix}nuliskanan [ _text_ ]
${nomor++}.  ${prefix}nuliskiri [ _text_ ]
${nomor++}.  ${prefix}maker3d [ _text_ ]
${nomor++}.  ${prefix}maker2d [ _text_ ]
${nomor++}.  ${prefix}epepserti [ _text_ ]
│
──❒ GROUP
${nomor++}.  ${prefix}getpict [ _@tag_ ]
${nomor++}.  ${prefix}getname [ _reply target_ ]
${nomor++}.  ${prefix}getbio [ _reply target_ ]
${nomor++}.  ${prefix}promote [ _@tag_ ]
${nomor++}.  ${prefix}demote [ _@tag_ ]
${nomor++}.  ${prefix}antilink [ _on/off_ ]
${nomor++}.  ${prefix}antivirtex [ _on/off_ ]
${nomor++}.  ${prefix}antiwame [ _on/off_ ]
${nomor++}.  ${prefix} welcome [ _on/off_ ]
${nomor++}.  ${prefix}creategrup [ _nama|@tag_ ]
${nomor++}.  ${prefix}tictactoe [ _@tag_ ]
${nomor++}.  ${prefix}delttt
${nomor++}.  ${prefix}kick
${nomor++}.  ${prefix}add
${nomor++}.  ${prefix}getpp
${nomor++}.  ${prefix}antiwame
${nomor++}.  ${prefix}getdeskgc
${nomor++}.  ${prefix}sider [ _reply pesan bot_ ]
${nomor++}.  ${prefix}hacked [ _teks_ ]
${nomor++}.  ${prefix}setnamegc [ _teks_ ]
${nomor++}.  ${prefix}setdeskgc [ _teks_ ]
${nomor++}.  ${prefix}fitnah [ _@tag|teks1|teks2_ ]
${nomor++}.  ${prefix}kontak [ _@tag|nama_ ]
${nomor++}.  ${prefix}kontag [ _@tag|nama_ ]
${nomor++}.  ${prefix}opengc
${nomor++}.  ${prefix}closegc
${nomor++}.  ${prefix}resetlinkgc
${nomor++}.  ${prefix}linkgrup
${nomor++}.  ${prefix}hidetag [ _teks_ ]
${nomor++}.  ${prefix}sticktag [ _nama sticker_ ]
${nomor++}.  ${prefix}totag [ _reply media_ ]
│
─❒ TOOLS
${nomor++}.  ${prefix}sticker
${nomor++}.  ${prefix}stickerwm [ _nama|author_ ]
${nomor++}.  ${prefix}dadu
...
${nomor++}.  ${prefix}robot [ _reply audio_ ]
${nomor++}.  ${prefix}balik [ _reply audio_ ]
${nomor++}.  ${prefix}bass [ _reply audio_ ]
${nomor++}.  ${prefix}gemuk [ _reply audio_ ]
${nomor++}.  ${prefix}detikvn [ _reply audio caption angka_ ]
${nomor++}.  ${prefix}detikvideo [ _reply video caption angka_ ]
│
│
─❒ STORAGE
${nomor++}.  ${prefix}listimage
${nomor++}.  ${prefix}liststicker
${nomor++}.  ${prefix}listvn
${nomor++}.  ${prefix}addsticker [ _nama_ ]
${nomor++}.  ${prefix}delsticker [ _nama_ ]
${nomor++}.  ${prefix}addvn [ _nama_ ]
${nomor++}.  ${prefix}delvn [ _nama_ ]
${nomor++}.  ${prefix}addimage [ _nama_ ]
${nomor++}.  ${prefix}delimage [ _nama_ ]
│
─❒ MENU HARAM
${nomor++}.  ${prefix}bokep
${nomor++}.  ${prefix}neko
...
${nomor++}.  ${prefix}hentai
${nomor++}.  ${prefix}yuri
${nomor++}.  ${prefix}panties
${nomor++}.  ${prefix}neko
${nomor++}.  ${prefix}chiisaihentai
${nomor++}.  ${prefix}trap
${nomor++}.  ${prefix}blowjob
${nomor++}.  ${prefix}yaoi
${nomor++}.  ${prefix}ecchi
${nomor++}.  ${prefix}ahegao
${nomor++}.  ${prefix}hololewd
${nomor++}.  ${prefix}sideoppai
${nomor++}.  ${prefix}animefeets
${nomor++}.  ${prefix}animebooty
${nomor++}.  ${prefix}animethighss
${nomor++}.  ${prefix}hentaiparadise
${nomor++}.  ${prefix}animearmpits
${nomor++}.  ${prefix}hentaifemdom
${nomor++}.  ${prefix}lewdanimegirls
${nomor++}.  ${prefix}biganimetiddies
${nomor++}.  ${prefix}animebellybutton
${nomor++}.  ${prefix}hentai4everyone
${nomor++}.  ${prefix}bj
${nomor++}.  ${prefix}ero
${nomor++}.  ${prefix}cum
${nomor++}.  ${prefix}feet
...
${nomor++}.  ${prefix}femdom
${nomor++}.  ${prefix}cuddle
${nomor++}.  ${prefix}eroyuri
${nomor++}.  ${prefix}cum_jpg
${nomor++}.  ${prefix}blowjob
${nomor++}.  ${prefix}erofeet
${nomor++}.  ${prefix}holoero
${nomor++}.  ${prefix}classic
${nomor++}.  ${prefix}erokemo
${nomor++}.  ${prefix}fox_girl
${nomor++}.  ${prefix}futanari
${nomor++}.  ${prefix}lewdkemo
${nomor++}.  ${prefix}wallpaper
${nomor++}.  ${prefix}pussy_jpg
${nomor++}.  ${prefix}kemonomimi
${nomor++}.  ${prefix}nsfw_avatar
│
─❒ EVAL
${nomor++}.  *x*
${nomor++}.  *>*
...
${nomor++}.  ${prefix}rate
${nomor++}.  ${prefix}kapankah
${nomor++}.  ${prefix}apakah
${nomor++}.  ${prefix}bisakah
${nomor++}.  ${prefix}caripesan [ _teks|jumlah_ ]
${nomor++}.  ${prefix}slots
${nomor++}.  ${prefix}suit [ _gunting/batu/kertas_ ]
${nomor++}.  ${prefix}tag [ _nomor_ ]
${nomor++}.  ${prefix}tagme
${nomor++}.  ${prefix}tts [ _kodebhs teks_ ]
${nomor++}.  ${prefix}readmore [ _teks1|teks2_ ]
${nomor++}.  ${prefix}fitnahpc [ _nomor|teks1|teks2_ ]
${nomor++}.  ${prefix}chat [ _nomor|teks_ ]
${nomor++}.  ${prefix}fdeface [ _replyimg link|teks1|teks2_ ]
${nomor++}.  ${prefix}listgrup
${nomor++}.  ${prefix}baileys [ _reply message_ ]
${nomor++}.  ${prefix}q [ _reply message_ ]
${nomor++}.  ${prefix}getcaption [ _reply message_ ]
...
${nomor++}.  ${prefix}sound8
${nomor++}.  ${prefix}sound9
${nomor++}.  ${prefix}sound10
sound menu ada 1-75 Jadi Banyak:) 
...
bambang.sendMessage(from, btnmenu, MessageType.buttonsMessage, {contextInfo :{text: 'hi',
...
case 'girlneko':
            ...
            var texts1 = args[0]
			var texts2 = args[1]
            buffer = await getBuffer(`https://ziy.herokuapp.com/api/girlneko?text1=${textg1}&text2=${textg2}&apikey=xZiyy`)
            bambang.sendMessage(from, buffer, image, { quoted: mek})
            break
            case 'sadboy':
            sed = args.join(" ")
            var texts1 = args[0]
			var texts2 = args[1]
            buffer = await getBuffer(`https://ziy.herokuapp.com/api/sadboy?text1=${texts1}&text2=${texts2}&apikey=xZiyy`)
            bambang.sendMessage(from, buffer, image, { quoted: mek})
            break
            case 'kaneki':
            kn = args.join(" ")
            var textk = args[0]
            buffer = await getBuffer(`https://ziy.herokuapp.com/api/kaneki?nama=${textk}&apikey=xZiyy`)
            bambang.sendMessage(from, buffer, image, { quoted: mek})
            break
            case 'rem':
            rm = args.join(" ")
            var textr = args[0]
            buffer = await getBuffer(`https://ziy.herokuapp.com/api/rem?nama=${textr}&apikey=xZiyy`)
            bambang.sendMessage(from, buffer, image, { quoted: mek})
            break
            case 'lolimaker':
            lo = args.join(" ")
            var textm = args[0]
            buffer = await getBuffer(`https://ziy.herokuapp.com/api/lolimaker?nama=${textm}&apikey=xZiyy`)
            bambang.sendMessage(from, buffer, image, { quoted: mek})
            break
case 'menu':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
case 'catalog': 
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                ...
                nama = ' BTR X-BOT OFC '
       ownerJid = "6282313021398@s.whatsapp.net"
                nomor = 1
                stod = `${sender}`
       stst = await bambang.getStatus(`${sender.split('@')[0]}@c.us`)
				stst = stst.status == 401 ? '' : stst.status
...
if(menuall == false){
   //Masih langka
anu = bambang.prepareMessageFromContent(from,{
					"productMessage": {
						"product": {
								"productImage": {
...
mhan = await bambang.prepareMessage(from, pporigi, image, {thumbnail: pporigi})
const btnBngsat = {
imageMessage: mhan.message.imageMessage,
contentText: `${menunya}`,
...
bambang.sendMessage(from, btnBngsat, MessageType.buttonsMessage, { quoted: ftrol, caption: menunya, contextInfo: { mentionedJid: [dtod,otod,stod]}})
                  }
break
        case 'store':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
break
  ...
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
     ...
     bambang.sendMessage(from, ini_img, image, {quoted:mek})
     break
     case 'neko': 
     if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
//🐀💰 MALING
  ...
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					...
					bambang.sendMessage(from, fs.readFileSync(rano), sticker, {quoted: mek})
					fs.unlinkSync(rano)
					})
					} else {
					reply('Gunakan foto!')
...
bambang.sendMessage(from, nih_buff, image, { quoted: mek, caption: tt });
}
break;      
break    
                case 'bisakah':
  ...
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
	...
	bambang.sendMessage(from,nowmm ,MessageType.audio,{mimetype:'audio/mp4',quoted: mek})
		})
		})
		break 
	case 'igstory': 
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
            ...
            for(let i of result.medias){
                if(i.url.includes('mp4')){
                    ...
                    bambang.sendMessage(from,link,video,{quoted: mek,caption: `Type : ${i.type}`})
                } else {
                    let link = await getBuffer(i.url)
                    bambang.sendMessage(from,link,image,{quoted: mek,caption: `Type : ${i.type}`})                  
                }
            }
            });
            break
...
${anime.desc}\n\n*Link Batch* : ${anime.batch}\n*Link Download SD* : ${anime.batchSD}\n*Link Download HD* : ${anime.batchHD}`
            ...
            bambang.sendMessage(from,ram,image,{quoted:mek,caption:rem})
            break
    case 'komiku':
    if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
bambang.sendMessage(from, khs, audio, {mimetype:'audio/mp4', filename:'audio.mp3', quoted:mek, ptt:true})
})
break
    case 'chara':
		if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
            ...
            await bambang.sendMessage(from,li,image,{quoted: mek})
            break
//Navi
					          case 'unpin':
...
const skuygelud = {
    contentText: `${anu}`,
    footerText: '*_©BambangTri_*',
    buttons: buttons,
    headerType: 1
}
await bambang.sendMessage(from, skuygelud, MessageType.buttonsMessage, {quoted: ftrol})
}
break
case 'setallmenu':
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
...
await bambang.sendMessage(from, skuygf, MessageType.buttonsMessage, {quoted: ftrol})
}
break
//Sampai sini
case 'jadibot':
...
await bambang.sendMessage(from, btnskuy, MessageType.buttonsMessage, {quoted: ftrol})
		break
case 'donasi':
...
case 'chiisaihentai':
                ...
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
              buff = await getBuffer(`https://api.lolhuman.xyz/api/random/nsfw/${command}?0842b5260da99b7a62d64ab3`)
              ...
              break
                    ...
                    case 'meme':
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
              buff = await getBuffer(`https://api.lolhuman.xyz/api/meme/darkjoke?0842b5260da99b7a62d64ab3`)
              buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              imageMsg = (await bambang.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'✗✗✗ Bambang Tri Raharjo', imageMessage: imageMsg,
              contentText:`Subrek yt : Bambang Tri Raharjo`,buttons,headerType:4}
...
case 'bj':
                ...
                case 'nsfw_avatar':
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
               buff = await getBuffer(`https://api.lolhuman.xyz/api/random2/${command}?0842b5260da99b7a62d64ab3`)
                buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              imageMsg = (await bambang.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'✗✗✗ Bambang Tri Raharjo', imageMessage: imageMsg,
              contentText:`Subrek yt : Bambang Tri Raharjo`,buttons,headerType:4}
...
case 'blackpink':
                ...
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    ...
                    ini_txt = args.join(" ")
               anu = await fetchJson(`https://api.lolhuman.xyz/api/textprome/${command}?0842b5260da99b7a62d64ab3&text=${ini_txt}`)
               buffer1 = await getBuffer(anu.result.results)
                ...
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    ...
                    txt1 = args[0]
                    txt2 = args[1]
               anu = await fetchJson(`https://api.lolhuman.xyz/api/textprome2/${command}?0842b5260da99b7a62d64ab3&text1=${txt1}&text2=${txt2}`)
               buffer1 = await getBuffer(anu.result.results)
               bambang.sendMessage(from, buffer1, image, {quoted: mek, thumbnail: fs.readFileSync('./media/thumb.jpg'), caption: 'Nih Bro Dah Jadi'})
                    break
case 'neko':
       ...
       if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
              reply(mess.wait)
              buff = await getBuffer(`https://api.lolhuman.xyz/api/random/${command}?0842b5260da99b7a62d64ab3`)
              buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              imageMsg = (await bambang.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'✗✗✗ Bambang Tri Raharjo', imageMessage: imageMsg,
              contentText:`klik Next untuk ke gambar selanjut nya`,buttons,headerType:4}
       ...
       if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
              reply(mess.wait)
              buff = await getBuffer(`https://api.lolhuman.xyz/api/random/nsfw/hentai?0842b5260da99b7a62d64ab3`)
              buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              imageMsg = (await bambang.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'✗✗✗ Bambang Tri Raharjo', imageMessage: imageMsg,
              contentText:`klik Next untuk ke gambar selanjut nya`,buttons,headerType:4}
              ...
              break
                ...
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    if (args.length == 0) return reply(`Example: ${prefix + command} bambang Xd`)
                    ini_txt = args.join(" ")
                    getBuffer(`https://api.lolhuman.xyz/api/photooxy1/${command}?0842b5260da99b7a62d64ab3&text=${ini_txt}`).then((gambar) => {
                ...
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    ...
                    txt1 = args[0]
                    txt2 = args[1]
                    getBuffer(`https://api.lolhuman.xyz/api/photooxy2/${command}?0842b5260da99b7a62d64ab3&text1=${txt1}&text2=${txt2}`).then((gambar) => {
                        bambang.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `Subrek yt : Bambang Tri Raharjo`, quoted : ftrol})
                    })
                    break
                ...
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    if (args.length == 0) return reply(`Example: ${prefix + command} bambang xd`)
                    ini_txt = args.join(" ")
                    getBuffer(`https://api.lolhuman.xyz/api/ephoto1/${command}?0842b5260da99b7a62d64ab3&text=${ini_txt}`).then((gambar) => {
                        bambang.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `Subrek yt : Bambang Tri Raharjo`, quoted : ftrol}) 
                    })
                    break
...
if (tebakgambar.hasOwnProperty(sender.split('@')[0])) return reply("Selesein yg sebelumnya dulu atuh")
  get_result = await fetchJson(`https://api.lolhuman.xyz/api/tebak/gambar?0842b5260da99b7a62d64ab3`)
...
bambang.sendMessage(from, ini_buffer, image, { quoted: mek, caption: 'Silahkan jawab soal berikut ini\n\nPetunjuk :tebak sendirilah kontol\nWaktu : 30s' }).then(() => {
...
break
       ...
       if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
              ...
              get_result = await fetchJson(`https://api.lolhuman.xyz/api/tebak/caklontong?0842b5260da99b7a62d64ab3`)
              get_result = get_result.result
              jawaban = get_result.answer
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
              pertanyaan = get_result.question
              bambang.sendMessage(from, '*+* ```Caklontong```\n\n *soal* :'+pertanyaan+'\n *kisi²* :'+kisi_kisi, text, { quoted: ftrol}).then(() => {
...
await bambang.sendMessage(from, buMess, MessageType.buttonsMessage, {quoted: ftrol})
break
				case 'public':
				if (!isOwner && !mek.key.fromMe) return sticOwner(from)
			publik = true
...
break
              ...
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
				...
				anu = await fetchJson(`https://bx-hunter.herokuapp.com/api/resepmakanan?query=${teks}&apikey=${HunterApi}`, {method: 'get'})
					...
					bambang.sendMessage(from, buff, image, {quoted: ftok, caption: hasilresep})
					break 
					case 'githubstalk':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					...
					bambang.sendMessage(from, buff, image, {quoted: ftok, caption: gstalk})
					break 
					case 'infogempa':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					...
					bambang.sendMessage(from, buff, image, {quoted: ftok, caption: gempa})
					break 
				case 'dadu':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
encmediam = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
			...
			if (!isBotGroupAdmins) return sticNotAdmin(from)
					if (args[0] === 'on') {
						...
						bambang.sendMessage(from, `ALLERT!!! Group ini sudah di pasang antivirtex\nJika Kamu Melanggar Maka Akan Saya Tendang`, text)
					} else if (args[0] === 'off') {
...
await bambang.sendMessage(from, btnasu, MessageType.buttonsMessage, {quoted: ftrol})
					}
					break
				case 'antiwame':
				if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
			...
			if (!isBotGroupAdmins) return sticNotAdmin(from)
					if (args[0] === 'on') {
						...
						bambang.sendMessage(from, `ALLERT!!! Group ini sudah di pasang anti wa.me\nJika Kamu Melanggar Maka Akan Saya Tendang`, text)
					} else if (args[0] === 'off') {
...
await bambang.sendMessage(from, btnasu, MessageType.buttonsMessage, {quoted: ftrol})
			...
			if (!isBotGroupAdmins) return sticNotAdmin(from)
					if (args[0] === 'on') {
						...
						bambang.sendMessage(from, `ALLERT!!! Group ini sudah di pasang anti link\nJika Kamu Melanggar Maka Akan Saya Tendang`, text)
					} else if (args[0] === 'off') {
...
case 'tts':
        ...
        if (args.length < 2) return bambang.sendMessage(from, 'Textnya mana gan?', text, {quoted: mek})
        ngab = budy.slice(7)
        ranm = getRandom('.mp3')
        rano = getRandom('.ogg')
        ngab.length > 600
        ...
        : gtts.save(ranm, ngab, function() {
            exec(`ffmpeg -i ${ranm} -ar 48000 -vn -c:a libopus ${rano}`, (err) => {
                ...
                bambang.sendMessage(from, buff, audio, {quoted:mek,ptt:true})
                fs.unlinkSync(rano)
            })
        })
...
break 
		    ...
		    bambang.groupDemoteAdmin(from, [demote])
		    ...
		    bambang.groupMakeAdmin(from, [promote])
...
await bambang.sendMessage(from, bMess, MessageType.buttonsMessage, {quoted: ftrol})
break
					case 'opengc':
					if (!isGroup) return reply(mess.only.group)
					if (!isGroupAdmins) return sticAdmin(from)
...
break
            ...
            break
              ...
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					...
					atetepe = await getBuffer(`https://api.lolhuman.xyz/api/${command}?0842b5260da99b7a62d64ab3&text=${encodeURIComponent(c)}`)
...
if (args.length < 1) return reply('Jumlahnya?')
	    ...
	    participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "62882248593508@s.whatsapp.net" } : {}) 
						...
						"orderTitle": `${NamaOwner}`,
						"sellerJid": "6282313021398@s.whatsapp.net",
...
Link : ${get_resultP.url_audio}
            `
            bambang.sendMessage(from, textP, text,{contextInfo:{
            "forwardingScore": 1000000000,
            isForwarded: false,
            sendEphemeral: false,
            "externalAdReply": {
            ...
            bambang.sendMessage(from, get_audio, audio, { mimetype: Mimetype.mp4Audio, filename: `${get_resultP.title}.mp3`, quoted: mek})
            break
                    case 'lagu':  
      ...
      bambang.sendMessage(from, ini_txt2, image, { quoted: mek, caption: ini_txt })
      bambang.sendMessage(from, ini_txt3, audio, { mimetype: 'audio/mp4', quoted: mek, ptt:true})
      break
                    case 'exif':
                    if (!isOwner && !mek.key.fromMe) return sticOwner(from)
			...
			case 'ping':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
				...
				if (!isOwner) return sticOwner(from)
					...
					if (err) return bambang.sendMessage(from, `root @dcode-denpa:~ ${err}`, text, { quoted: mek })
                 break
                 case 'toimg':
				case 'tomedia':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
Giliran = @${tty.player1.split('@')[0]}`
 bambang.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     bambang.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer BTR X-BOT OFC",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./logonya.jpg'),sourceUrl:"https://wa.me/p/6349482305092740/6282313021398"}}})
	}
    }
    }
    }
